...
SBOM_LEDGER_URL = (
    os.getenv("SBOM_LEDGER_URL", "").strip()
    or f"{LEDGER_BASE_URL}{SBOM_LEDGER_ENDPOINT}"
)
...
TOE_ID_HANDOFF_ENABLED = _env_bool("TOE_ID_HANDOFF_ENABLED", True)
TOE_CONNECTOR_BASE_URL = (
    _env_url("TOE_CONNECTOR_BASE_URL")
    or "http://ai-target-of-evaluation.cobalt.local:30005"
)
...
TOE_CONNECTOR_RETRY_MAX_SECONDS = _env_float("TOE_CONNECTOR_RETRY_MAX_SECONDS", 30)
